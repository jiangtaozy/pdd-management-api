...
const createPddItem =`
  CREATE TABLE IF NOT EXISTS pddItem (
    ...
    displayPriority VARCHAR(10) NOT NULL DEFAULT '',
    ...
    titleScrFlag BOOLEAN NOT NULL DEFAULT false,
    titleDesc VARCHAR(50),
    propsScrFlag BOOLEAN NOT NULL DEFAULT false,
    propsDesc VARCHAR(50),
    galleryScrFlag BOOLEAN NOT NULL DEFAULT false,
    galleryDesc VARCHAR(50),
    galleryVideoScrFlag BOOLEAN NOT NULL DEFAULT false,
    longGraphScrFlag BOOLEAN NOT NULL DEFAULT false,
    whiteGraphScrFlag BOOLEAN NOT NULL DEFAULT false,
